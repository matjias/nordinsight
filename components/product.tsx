  ...
  return (
    <div className={styles.wrapper}>
      <ShowWhenInView style="fade-in">
        <h3>
          MRI scan&#39;s come with a slew of risks. Together, we can reduce
          them.
        </h3>
        ...
        <div className={styles.points}>
          ...
          <ShowWhenInView style="fade-in">
            <div className={styles["point-element"]}>
              ...
              <p>
                When the system is tailored to your needs, it&#39;s
                exceptionally easy to use. And thats the case with our database
              </p>
            </div>
          </ShowWhenInView>
        </div>
